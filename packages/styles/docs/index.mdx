# skrt.css
> A base stylesheet for the [skrt][skrtUrl] static site generator
...
<div className="w-48 md:w-56 text-center pt-2">
  <button className="button">
    Button Label
  </button>
  <div className="pt-2">
...
<div className="grid grid-cols-3 gap-8 pt-2">
  <div className="col-span-3 md:col-span-1">
    <div className="w-48 md:w-56 text-center">
      <a href="#" className="button button-blue" role="button">
        Button Label
      </a>
      <div className="pt-2">
  ...
  <div className="col-span-3 md:col-span-1">
    <div className="w-48 md:w-56 text-center">
      <a href="#" className="button button-red" role="button">
        Button Label
      </a>
      <div className="pt-2">
  ...
  <div className="col-span-3 md:col-span-1">
    <div className="w-48 md:w-56 text-center">
      <a href="#" className="button button-green" role="button">
        Button Label
      </a>
      <div className="pt-2">
...
[skrtUrl]: https://skrt.generates.io
